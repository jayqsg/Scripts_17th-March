...
are not retrieved, when "Transaction & Capital Markets >> M&A" search is performed
...
When I update TestCaseName Verify 'Service' project other than "Investment Banker" sub role are not retrieved, when "Transaction & Capital Markets >> M&A" search is performed
