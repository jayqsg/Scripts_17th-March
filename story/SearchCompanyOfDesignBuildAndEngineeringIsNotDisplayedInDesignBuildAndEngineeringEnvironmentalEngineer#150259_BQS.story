...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Environmental Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Environmental Engineer" are not retrieved.

Scenario: TC 150259 :  Search and Verify the company of "Design, Build & Engineering role" role in "Design, Build & Engineering >> Environmental Engineer" search is not retrieved
When I update TestCaseId 150259
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Environmental Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Environmental Engineer" are not retrieved.
