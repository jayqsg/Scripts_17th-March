...
Narrative:
As a user
I Perform: "Investments >> Outright Sales" search Verify that "Projects and Listing" with "Outright Sales" requirement in it are retrieved.

Scenario: TC 155632: Verify desired postings are displayed in "Investments >> Outright Sales" search result
When I update TestCaseId 155632
When I update TestCaseName Perform: "Investments >> Outright Sales" search Verify that "Projects and Listing" with "Outright Sales" requirement in it are retrieved.
...
And I click on 'Invest or Lend' link
And I click on 'Outright Sales' link
And I select Postings option in filter by label
