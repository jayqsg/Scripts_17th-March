...
are retrieved, when "Transaction And Capital Market >> Commercial Broker" search is performed

Scenario: TC 1384091: Verify companies of broker is retrieved when search is performed
When I update TestCaseId 1384091
When I update TestCaseName Perform: "Transaction And Capital Market >> Commercial Broker" search Verify that companies of "Broker" sub role users are retrieved.
...
And I click on 'Commercial Brokers' link
Then I should see 'Transaction & Capital Markets' as find in search option
And I should see sub role as 'Commercial Brokers'
