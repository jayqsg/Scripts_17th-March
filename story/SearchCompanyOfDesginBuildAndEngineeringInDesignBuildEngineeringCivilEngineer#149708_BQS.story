...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Civil Engineer" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Civil Engineer" are retrieved.

Scenario: TC 149708 :  Search and Verify the company of "Design, Build & Engineering role" role in "Design, Build & Engineering >> Civil Engineer" search
When I update TestCaseId 149708
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Civil Engineer" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Civil Engineer" are retrieved.
