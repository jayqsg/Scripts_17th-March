...
Narrative:
As a user
I search posting name of user and is displayed in Investments Outright Sales.

Scenario: TC 1161232: Verify postings are not displayed in the search result
When I update TestCaseId 1161232
When I update TestCaseName I search posting name of user and is not displayed in Investments Outright Sales.
