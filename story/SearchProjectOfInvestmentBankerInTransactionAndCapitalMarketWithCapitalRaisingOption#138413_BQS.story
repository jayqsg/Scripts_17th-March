...
are retrieved, when "Transaction & Capital Markets >> Capital Raising" search is performed
...
When I update TestCaseName Verify 'Service' project of "Investment Banker" sub role are retrieved, when "Transaction & Capital Markets >> Capital Raising" search is performed
