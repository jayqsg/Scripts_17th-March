...
are retrieved, when "Transaction And Capital Market >> Research" search is performed

Scenario: TC 1384051: Verify companies of advisor is retrieved when Advisor search is performed
When I update TestCaseId 1384051
When I update TestCaseName Perform: "Transaction And Capital Market >> Research" search Verify that companies of "Advisor" sub role users are retrieved.
