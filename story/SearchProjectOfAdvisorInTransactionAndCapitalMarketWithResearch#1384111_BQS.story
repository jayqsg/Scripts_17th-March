...
are retrieved, when "Transaction & Capital Markets >> Research" search is performed
...
When I update TestCaseName Verify service project of "Advisor" sub role user are retrieved, when "Transaction & Capital Markets >> Research" search is performed
