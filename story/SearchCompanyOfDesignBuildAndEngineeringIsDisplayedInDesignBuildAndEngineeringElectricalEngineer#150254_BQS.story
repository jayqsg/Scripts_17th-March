...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Electrical Engineer" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Electrical Engineer" are retrieved.

Scenario: TC 150254 :  Search and Verify the company of "Design, Build & Engineering role" role in "Design, Build & Engineering >> Electrical Engineer" search
When I update TestCaseId 150254
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Electrical Engineer" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Electrical Engineer" are retrieved.
