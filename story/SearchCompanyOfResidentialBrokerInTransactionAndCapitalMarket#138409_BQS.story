...
are retrieved, when "Transaction And Capital Market >> Residential Broker" search is performed

Scenario: TC 138409: Verify companies of broker is retrieved when search is performed
When I update TestCaseId 138409
When I update TestCaseName Perform: "Transaction And Capital Market >> Residential Broker" search Verify that companies of "Broker" sub role users are retrieved.
