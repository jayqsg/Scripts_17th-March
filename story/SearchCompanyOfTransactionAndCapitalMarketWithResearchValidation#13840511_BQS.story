...
are not retrieved, when "Transaction And Capital Market >> Research" search is performed

Scenario: TC 13840511: Verify companies other than advisor sub role is not retrieved when search is performed
When I update TestCaseId 13840511
When I update TestCaseName Perform: "Transaction And Capital Market >> Research" search Verify that companies other than "Advisor" sub role users are not retrieved.
