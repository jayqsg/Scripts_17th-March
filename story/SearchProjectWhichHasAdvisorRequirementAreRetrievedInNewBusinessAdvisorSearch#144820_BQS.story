...
Narrative:
As a user
Perform "Find New Clients >> Advisor" search and verify that projects that has a advisor requirement which matches the filters are retrieved.
...
When I update TestCaseName Perform "Find New Clients >> Advisor" search and verify that projects that has a advisor requirement which matches the filters are retrieved.
...
And I should see 'Environmental Inspection' as strategy in search option
