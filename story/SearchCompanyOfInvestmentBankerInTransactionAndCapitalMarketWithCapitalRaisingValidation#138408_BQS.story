...
when "Transaction & Capital Markets >> Capital Raising" search is performed
...
When I update TestCaseName Perform: "Transaction & Capital Markets >> Capital Raising" search Verify that companies other than "Investment Banker" sub role users are not retrieved.
