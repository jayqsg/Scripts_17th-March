...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Health & Safety Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Health & Safety Engineer" are not retrieved.

Scenario: TC 150267 :  Search and Verify the company of "Design, Build & Engineering role" role in "Design, Build & Engineering >> Health & Safety Engineer" search is not retrieved
When I update TestCaseId 150267
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Health & Safety Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Health & Safety Engineer" are not retrieved.
