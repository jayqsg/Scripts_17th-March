...
not retrieved, when "Transaction & Capital Markets >> Other" search is performed

Scenario: TC 1384122: Verify service project other than advisor sub role is not retrieved when search is performed
When I update TestCaseId 1384122
When I update TestCaseName Verify service project other than "Advisor" sub role user are not retrieved, when "Transaction & Capital Markets >> Other" search is performed
