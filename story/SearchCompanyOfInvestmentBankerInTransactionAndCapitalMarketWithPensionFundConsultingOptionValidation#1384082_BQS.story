...
when "Transaction & Capital Markets >> Pension Fund Consultant" search is performed
...
When I update TestCaseName Perform: "Transaction & Capital Markets >> Pension Fund Consultant" search Verify that companies other than "Investment Banker" sub role users are not retrieved.
