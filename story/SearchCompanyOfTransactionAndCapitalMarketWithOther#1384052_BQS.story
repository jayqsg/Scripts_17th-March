...
are retrieved, when "Transaction And Capital Market >> Other" search is performed

Scenario: TC 1384052: Verify companies of advisor is retrieved when Advisor search is performed
When I update TestCaseId 1384052
When I update TestCaseName Perform: "Transaction And Capital Market >> Other" search Verify that companies of "Advisor" sub role users are retrieved.
