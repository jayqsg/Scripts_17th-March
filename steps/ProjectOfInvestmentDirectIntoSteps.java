...
public class ProjectOfInvestmentDirectIntoSteps {
    ...
    @Alias("I click on project posting in 'Invest or Lend' search")
    ...
    @Alias("I click on listing posting in 'Invest or Lend' search")
    ...
    @Then("I verify '$strKindOptions' is displayed in kind field of search option region")
    public void verifyKindInSearchOptionOfInvestOrLend(@Named("strKindOptions") String strKindOptions){
        projectOfInvestmentBankerDirectIntoPage.verifyKindInSearchOptionOfInvestOrLend(strKindOptions);
    }
}
