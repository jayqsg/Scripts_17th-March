...
public class DeveloperDealAndFundSponsorSteps {
    ...
    @Then("I verify '$strUserName' is displayed in search result")
    public void verifyUser(@Named("strUserName") String strUserName){
        developerDealAndFundSponsorPage.verifyUser(strUserName);
    }
}
