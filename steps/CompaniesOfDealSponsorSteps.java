...
public class CompaniesOfDealSponsorSteps {
    ...
    @When("I click on '$strCompanyName' company name")
    public void clickDealSponsorCompanyName(@Named("strCompanyName") String strCompanyName){
        companiesOfDealSponsorPage.clickDealSponsorCompanyName(strCompanyName);
    }
}
