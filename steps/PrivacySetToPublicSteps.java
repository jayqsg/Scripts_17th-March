...
public class PrivacySetToPublicSteps {
    ...
    @When("I enter '$strPrivacyCompanyName' company name")
    public void enterPrivacyCompanyName(@Named("strPrivacyCompanyName") String strPrivacyCompanyName){
        privacySetToPublicPage.enterPrivacyCompanyName(strPrivacyCompanyName);
    }
}
