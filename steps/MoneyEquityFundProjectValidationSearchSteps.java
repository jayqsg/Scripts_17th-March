...
public class MoneyEquityFundProjectValidationSearchSteps {
    ...
    @When("I set the value for deal size field")
    public void setValueForDealSize(){
        moneyEquityFundProjectValidationSearchPage.setValueForDealSize();
    }

    @When("I clear the value for deal size field")
    public void clearValueForDealSize(){
        moneyEquityFundProjectValidationSearchPage.clearValueForDealSize();
    }
    ...
    public void setValueOfInvestmentAmount_Money(){
        moneyEquityFundProjectValidationSearchPage.setValueOfInvestmentAmount_Money();
    }

    @When("I clear the value of investment amount in money search")
    public void clearValueOfInvestmentAmount(){
        moneyEquityFundProjectValidationSearchPage.clearValueOfInvestmentAmount_Money();
    }
