...
public class ProjectOfInvestmentBankerSearchValidationPage extends FluentWebDriverPage {
    ...
    public void verifyServiceNameOfInvestmentBankerNotDisplayed(String strServiceNameIsNotDisplayed){
        ...
        Assert.assertFalse(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strServiceNameIsNotDisplayed+"']"), getDriverProvider().get()));
    }
    ...
    public void verifyAllOptionsOfInvestmentBankerService(int RowIndex){
        ...
        try {
            ...
            //wait until page loads
            WaitUtil.simpleSleep(5000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strAllServiceName+"']"), getDriverProvider().get()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void serviceOfInvestmentBankerNotDisplayed(int RowIndex, String strColumnName) throws Exception {
        ...
        Assert.assertFalse(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strCompanyName+"']"),getDriverProvider().get()));
    }
    ...
    public void serviceOfInvestmentBankerIsDisplayed(int RowIndex,String strColumnName){
        ...
        try {
            ...
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strOtherUser+"']"), getDriverProvider().get()));
        }
        catch (Exception e) {
