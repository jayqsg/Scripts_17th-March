...
public class ProjectOfInvestmentDirectIntoPage extends FluentWebDriverPage {
    ...
    public void clickProjectOfBanker(int RowIndex){
        try {
            WaitUtil.simpleSleep(1000);
             ...
             findElement(By.xpath("//strong[text()='"+strProjectName+"']")).click();
            WaitUtil.simpleSleep(1000);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void clickListingOfBanker(int RowIndex){
        try {
            ...
            findElement(By.xpath("//strong[contains(text(),'" + strListingName + "')]")).click();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void verifyProjectOfInvestmentBanker(int RowIndex){
        try {
            ...
            LoginRealConnexPage.gStrReason = LoginRealConnexPage.gStrReason +"; "+"Project Deal is not displayed in search results\n";
        }
    }
    ...
    public void verifyListingOfInvestmentBanker(int RowIndex){
        try {
            ...
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strListing+"']"),getDriverProvider().get()));
        } catch (AssertionError A) {
            LoginRealConnexPage.gStrReason = LoginRealConnexPage.gStrReason +"; "+"Listing Project is not displayed in search results\n";
        } catch (Exception e) {
    ...
    public void verifyKindInSearchOptionOfInvestOrLend(String strKindOptions){
        try {
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//div[@id='searchFilters']/div/span/strong[contains(text(),'"+strKindOptions+"')]"),getDriverProvider().get()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
