...
public class PrivacySetToPublicPage extends FluentWebDriverPage {
    ...
    public void enterPrivacyCompanyName(String strPrivacyCompanyName){
        try{
            gStrFieldName = "";
            WaitUtil.simpleSleep(1000);
            ...
            findElement(By.id("CompanyTitle")).sendKeys(strPrivacyCompanyName);
            WaitUtil.simpleSleep(3000);
        } catch (AssertionError A) {
            System.out.println(A);
            LoginRealConnexPage.gStrReason = LoginRealConnexPage.gStrReason +";"+"Affected Field:"+gStrFieldName+"\nReason of Error:"+""+strPrivacyCompanyName+" company name is not displayed\n";
        }
    }
