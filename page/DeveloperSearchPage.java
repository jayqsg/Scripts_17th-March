...
public class DeveloperSearchPage extends FluentWebDriverPage {
    ...
    public void verifyDeveloperNameIsDisplayed(int RowIndex){
        try{
            executeScript("scrollTo(250,0)");
            String strDeveloperName = ReadData.readDataExcel("DealSponsorDeveloperFund", RowIndex, "VerifyDeveloperName");
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strDeveloperName+"']"), getDriverProvider().get()));
        } catch (Exception e) {
            System.out.println(e);
        }
    }
    ...
    public void clickOnDeveloperName(int RowIndex){
        try{
            ...
            String strDeveloperName = ReadData.readDataExcel("DealSponsorDeveloperFund", RowIndex, "VerifyDeveloperName");
            findElement(By.xpath("//strong[text()='"+strDeveloperName+"')]")).click();
        } catch (Exception e) {
            System.out.println(e);
        }
    }
    ...
    public void searchedDeveloperCompany(int RowIndex){
        ...
        try{
            ...
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[contains(text()='"+strDeveloperCompanyName+"')]"), getDriverProvider().get()));
        } catch (Exception e) {
            System.out.println(e);
        }
    }
    ...
    public void clickOnDeveloperCompany(int RowIndex){
        try{
            String strDeveloperCompanyName = ReadData.readDataExcel("CompaniesOfDealDeveloperFund", RowIndex, "VerifyDeveloperCompanyName");
            findElement(By.xpath("//strong[text()='"+strDeveloperCompanyName+"']")).click();
        } catch (Exception e) {
            System.out.println(e);
        }
    }
    ...
    public void selectCompaniesOptionFromFilterByField(){
        //wait until page loads
        WaitUtil.simpleSleep(10000);
        findElement(By.xpath("//i[@class='arrow']")).click();
        findElement(By.xpath("//li[text()='Companies']")).click();
        WaitUtil.simpleSleep(10000);
    }
