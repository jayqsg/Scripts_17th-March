...
public class PeopleSearchValidationPage extends FluentWebDriverPage {
    ...
    public void verifyInvestorUserNameNotDisplayed(String strInvestorUserName){
        ...
        ReasonsInResultSheet.assertStatementIfElementIsNotPresentAndFieldName(By.xpath("//a/strong[text()='"+strInvestorUserName+"']"), getDriverProvider().get());
    }

    public void verifyInvestorUserNameIsDisplayed(String strInvestorUserName){
        //wait until page loads
        WaitUtil.simpleSleep(3000);
        ReasonsInResultSheet.assertStatementIfElementIsPresent(By.xpath("//tbody[@id='searchResults']/tr/td/a/strong/span[contains(text(),'"+strInvestorUserName+"')]"), getDriverProvider().get(),strInvestorUserName);
    }
