...
public class MoneyDebtLoanCompanyPage extends FluentWebDriverPage{
    ...
    public void verifyCompanyNameDebtLoan(String strCompanyNameDebtLoan){
        ...
        Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strCompanyNameDebtLoan+"']"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
            LoginRealConnexPage.gStrReason = LoginRealConnexPage.gStrReason +"; "+""+strCompanyNameDebtLoan+" Company is Not Retrieved in Search Result\n";
        }
    }
