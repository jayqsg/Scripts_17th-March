...
public class DealSponsorValidationPage extends FluentWebDriverPage{
    ...
    public void verifyUser(int RowIndex,String strColumnName){
        ...
        try {
            ...
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//tbody[@id='searchResults']/tr/td/a/strong[text()='"+strUser+"']"), getDriverProvider().get()));
        } catch (Exception e) {
    ...
    public void userOfAllSearchOption(int RowIndex) {
        try {
            ...
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//tbody[@id='searchResults']/tr/td/a/strong[text()='"+strDealSponsorUser+"']"),getDriverProvider().get()));
        } catch (Exception e) {
            System.out.println(e);
        }
