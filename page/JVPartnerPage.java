...
public class JVPartnerPage extends FluentWebDriverPage {
    ...
    public void verifyDealSponsorProjectNameIsDisplayedNameInOtherSearch(String strDealSponsorProjectName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[contains(text(),'"+strDealSponsorProjectName+"')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyInvestorFundNameIsDisplayedNameInOtherSearch(String strInvestorFundName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[contains(text(),'"+strInvestorFundName+"')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderLoanNameIsDisplayedNameInOtherSearch(String strLenderLoanName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[contains(text(),'" + strLenderLoanName + "')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderMezzNameIsDisplayedNameInOtherSearch(String strLenderMezzName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[contains(text(),'"+strLenderMezzName+"')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyAdvisorListingNameIsDisplayedNameInOtherSearch(String strAdvisorListingName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[contains(text(),'"+strAdvisorListingName+"')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyProjectNameIsDisplayedInSearchResultToFilterSelected_OtherSearch(String strDealSponsorProjectName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strDealSponsorProjectName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyInvestorFundNameIsDisplayedInSearchResultToFilterSelected_OtherSearching(String strInvestorFundName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strInvestorFundName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderLoanNameIsDisplayedInSearchResultToFilterSelected_OtherSearch(String strLenderLoanName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strLenderLoanName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderMezzNameIsDisplayedInSearchResultToFilterSelected_OtherSearch(String strLenderMezzName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strLenderMezzName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyAdvisorListingNameIsDisplayedInSearchResultToFilterSelected_OtherSearch(String strAdvisorListingName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strAdvisorListingName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyDealSponsorFundNameIsNotDisplayedNameInProjectSearch(String strDealSponsorFundName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[contains(text(),'" + strDealSponsorFundName + "')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyDealSponsorProjectNameIsNotDisplayedNameInProjectSearch(String strDealSponsorProjectName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[contains(text(),'" + strDealSponsorProjectName + "')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderLoanNameIsNotDisplayedNameInProjectSearch(String strLenderLoanName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[contains(text(),'" + strLenderLoanName + "')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderMezzNameIsNotDisplayedNameInProjectSearch(String strLenderMezzName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[contains(text(),'" + strLenderMezzName + "')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyAdvisorListingNameIsNotDisplayedNameInProjectSearch(String strAdvisorListingName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[contains(text(),'" + strAdvisorListingName + "')]"), getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
        ...
        while(!blnFound && intCnt<=5){
            try{
                ...
                if (!findElement(By.xpath("//section[@id='content']/div/div/ng-include/section/div/div/div[@class='item cycle-slide ng-scope']/ul/li/div[@class='action-block']/a/i[@class='fa fa-pencil']")).isDisplayed()) {
                    ...
                    findElement(By.xpath("//section[@id='content']/div[2]/div[2]/ng-include/section/div/div/div[3]/ul/li[2]/div[3]/a[1]/i")).click();
                    blnFound=true;
                }
            }catch (NoSuchElementException N){
                WaitUtil.simpleSleep(1000);
    ...
    public void verifyFundNameIsNotDisplayedInSearchResultToFilterSelected_ProjectSearch(String strDealSponsorFundName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[text()='"+strDealSponsorFundName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyProjectNameIsNotDisplayedInSearchResultToFilterSelected_ProjectSearch(String strDealSponsorProjectName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[text()='"+strDealSponsorProjectName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderLoanNameIsNotDisplayedInSearchResultToFilterSelected_ProjectSearch(String strLenderLoanName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[text()='"+strLenderLoanName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyLenderMezzNameIsNotDisplayedInSearchResultToFilterSelected_ProjectSearch(String strLenderMezzName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[text()='"+strLenderMezzName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
    ...
    public void verifyAdvisorListingNameIsNotDisplayedInSearchResultToFilterSelected_ProjectSearch(String strAdvisorListingName){
        try{
            //wait until page loads
            WaitUtil.simpleSleep(1000);
            Assert.assertTrue(WaitUtil.isElementNotPresent(By.xpath("//strong[text()='"+strAdvisorListingName+"']"),getDriverProvider().get()));
        } catch (AssertionError A){
            System.out.println(A);
