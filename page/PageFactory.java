...
public class PageFactory {
   ...
   /* public  BrowserPage newBrowserPage() {
    ...
    public CompanyOfTransactionAndCapitalMarketAdvisorSearchPage newCompanyOfAdvisorSearchPage(){
        return new CompanyOfTransactionAndCapitalMarketAdvisorSearchPage(webDriverProvider);
    }

    public CompanyOfTransactionAndCapitalMarketAdvisorValidationPage newCompanyOfAdvisorValidationPage(){
        return  new CompanyOfTransactionAndCapitalMarketAdvisorValidationPage(webDriverProvider);
    }

    public CompanyOfTransactionAndCapitalMarketBrokerPage newCompanyOfBrokerPage(){
        return new CompanyOfTransactionAndCapitalMarketBrokerPage(webDriverProvider);
    }

    public CompanyOfTransactionAndCapitalMarketBrokerValidationPage newCompanyOfBrokerValidationPage(){
        return new CompanyOfTransactionAndCapitalMarketBrokerValidationPage(webDriverProvider);
    }
    ...
    public LoadTimeForMessageTabPage newLoadTimeForMessageTabPage() {
        return new LoadTimeForMessageTabPage(webDriverProvider);
    }

    public FindClientPage newFindClientPage() {
        return new FindClientPage(webDriverProvider);
    }
}