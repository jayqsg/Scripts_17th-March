...
public class CompanyOfTransactionAndCapitalMarketBrokerPage extends FluentWebDriverPage {
    ReadData ReadData = new ReadData();
    public CompanyOfTransactionAndCapitalMarketBrokerPage(WebDriverProvider driverProvider){
    ...
    public void verifyBrokerCompany(int RowIndex){
        ...
        try{
            ...
            Assert.assertTrue(WaitUtil.isElementPresent(By.xpath("//strong[text()='"+strBrokerCompanyName+"']"), getDriverProvider().get()));
        } catch (Exception e) {
            System.out.println(e);
        }
    }
