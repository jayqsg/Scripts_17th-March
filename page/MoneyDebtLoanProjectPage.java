...
public class MoneyDebtLoanProjectPage extends FluentWebDriverPage {
    ...
    public void verifyProjectNameDebtLoan(String strProjectName){
        try{
            ...
            LoginRealConnexPage.gStrReason = LoginRealConnexPage.gStrReason +"; "+""+strProjectName+" Company name is not displayed\n";
        }
    }
    ...
    public void selectPostingOptionFromFilterByField(){
        //wait until page loads
        WaitUtil.simpleSleep(5000);
        findElement(By.xpath("//i[@class='arrow']")).click();
        findElement(By.xpath("//li[text()='Postings']")).click();
        WaitUtil.simpleSleep(10000);
    }
